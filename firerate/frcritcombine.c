...
const int ACC=80;				//  80  ACC is for z-axis sorting and for the length of the interval tree
const int ACC_TR=750;		// 750  ACC_TR is for firerate comparisons inside tree
#include "frcrit_utils.h"
...
void worker(int len, int output_options)
{
	...
	gem_init(pool[0],1,1,1,1);		// grade damage crit firerate
	pool_length[0]=1;
