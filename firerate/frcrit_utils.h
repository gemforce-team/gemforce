#ifndef _FRCRIT_UTILS_H
#define _FRCRIT_UTILS_H
...
struct Gem_YB {
	...
	struct Gem_YB* father;  // maximize damage*firerate*crit*firerate
...
{
	return gem1.damage*gem1.firerate*gem1.crit*gem1.firerate;
}
...
inline double gem_cfr_power(gem gem1, double amp_damage_scaled, double amp_crit_scaled)
{
	...
	return (gem1.damage+amp_damage_scaled)*gem1.firerate*(gem1.crit+amp_crit_scaled)*gem1.firerate;
}
