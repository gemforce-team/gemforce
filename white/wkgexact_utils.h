...
struct Gem_YBp {
	...
	struct Gem_YBp* father; // maximize damage*pbound*crit*pbound
...
{
	return gem1.damage*gem1.pbound*gem1.crit*gem1.pbound;
}

inline double gemP_bbd(gemP gem1)
{
	return gem1.pbound*gem1.pbound*gem1.damage;
}

inline double gemP_bbc(gemP gem1)
{
	return gem1.pbound*gem1.pbound*gem1.crit;
}
